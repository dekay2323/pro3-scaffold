...
<html>
    ...
    <body>
        ...
        <div id="show-strategy" class="content scaffold-show" role="main">
            ...
            <f:display bean="strategy" />
            <g:form resource="${this.strategy}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.strategy}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
