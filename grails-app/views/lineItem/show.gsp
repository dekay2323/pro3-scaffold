...
<html>
    ...
    <body>
        ...
        <div id="show-lineItem" class="content scaffold-show" role="main">
            ...
            <f:display bean="lineItem" />
            <g:form resource="${this.lineItem}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.lineItem}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
